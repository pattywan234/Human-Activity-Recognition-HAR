...
X_train = np.load("wesad/S2/test/X_train_tt.npy")
X_test = np.load("wesad/S2/test/X_test_tt.npy")
y_train = np.load("wesad/S2/test/y_train_tt.npy")
y_test = np.load("wesad/S2/test/y_test_tt.npy")
...
"""
pickle.dump(history, open('data/LSTM-data/PAMAP2/histpry1-50.p', 'wb'))
np.save('data/LSTM-data/PAMAP2/predictions1-50.npy', predictions)
tf.train.write_graph(sess.graph_def, '.', 'data/LSTM-data/PAMAP2/har1-50.pbtxt')
saver.save(sess, save_path="data/LSTM-data/PAMAP2/har1-50.ckpt")
"""
sess.close()

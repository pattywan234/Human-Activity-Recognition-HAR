...
from RNN_model01 import create_RNN_model, var_create_RNN
...
with tf.Session() as sess:
    ...
    w_rnn, b_rnn = var_create_RNN(N_FEATURES, N_HIDDEN, N_CLASSES)
    pred_Y_rnn = create_RNN_model(X_rnn, N_FEATURES, N_HIDDEN, N_TIME_STEPS, w_rnn, b_rnn)
    ...
    np.save(f'wesad/all_subjects/predict_lr{lr}.npy', predictions_rnn)
    sess.close()

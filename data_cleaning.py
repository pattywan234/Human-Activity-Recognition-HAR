...
rx_2 = np.asarray(x_2).reshape(len(label_2))
ry_2 = np.asarray(y_2).reshape(len(label_2))
rz_2 = np.asarray(z_2).reshape(len(label_2))
recg_2 = np.asarray(ecg_2).reshape(len(label_2))
reda_2 = np.asarray(eda_2).reshape(len(label_2))
remg_2 = np.asarray(emg_2).reshape(len(label_2))
rresp_2 = np.asarray(resp_2).reshape(len(label_2))
rtemp_2 = np.asarray(temp_2).reshape(len(label_2))
...
rx_4 = np.asarray(x_4).reshape(len(label_4))
ry_4 = np.asarray(y_4).reshape(len(label_4))
rz_4 = np.asarray(z_4).reshape(len(label_4))
recg_4 = np.asarray(ecg_4).reshape(len(label_4))
reda_4 = np.asarray(eda_4).reshape(len(label_4))
remg_4 = np.asarray(emg_4).reshape(len(label_4))
rresp_4 = np.asarray(resp_4).reshape(len(label_4))
rtemp_4 = np.asarray(temp_4).reshape(len(label_4))
